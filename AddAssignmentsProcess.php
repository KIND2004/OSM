...
if (isset($_SESSION["user"])) {
    ...
    if (isset($_POST["subject"]) && isset($_POST["grade"]) && isset($_POST["id"]) && isset($_FILES["assignment"])) {
        ...
        if ($subject == "0") {
            ...
            if (in_array($file_extension, $allowed_image_extension)) {
                ...
                if ($ResultSet->num_rows == 1) {
                    ...
                    Database::iud("INSERT INTO `assignments`(`date`,`teacher_has_subject_id`,`path`) VALUES('" . $date . "','" . $TeacherHasSubjectId["id"] . "','" . $FileName . "')");
                    echo "Success";
                } else {
